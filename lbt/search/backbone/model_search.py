...
from lbt.util.prim_ops_set import *
from lbt.util.genotype import *
from lbt.search.backbone.cell import Cell
...
class Network(nn.Module):
    ...
    def __init__(self, input_c, c, num_classes, criterion, depth, device= None, meta_node_num=4,
                 use_sharing=True, double_down_channel=True, use_softmax_head = False, multi_gpus=False):
